				...
				<div className='flex flex-col w-full max-[1000px]:items-center min-[1000px]:flex-row items-start gap-8'>
					...
					<div className='md:w-1/2'>
						...
						<div className='flex items-center justify-between'>
							...
							<button onClick={handleAddToCart} className='bg-[#121214] p-[23px_40px] text-white max-[600px]:p-[10px_10px] rounded max-[600px]:text-[14px] cursor-pointer'>
								Добавить в корзину
							</button>
						</div>
						{/* Tabs */}
